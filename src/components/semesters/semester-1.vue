<template>
  <div class="megacontainer flex">
    <h1>First Semester</h1>
    <div class="master flex">
      <div class="col flex">
        <h3>Notes</h3>
        <ul id="hover" class="flex">
...
box-shadow: 0px 0px 13px 3px #191919;

  animation: slideInFromRight 300ms ease-in;
}
